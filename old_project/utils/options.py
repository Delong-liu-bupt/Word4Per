...
def get_args():
    parser = argparse.ArgumentParser(description="Word4Per Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--pretrain_choice", default='ViT-B/16') # whether use pretrained model, ViT-L/14, ViT-B/16
    ...
    parser.add_argument("--mlp_depth", type=int, default=2, help='Word4per stage2 mlp depth')
    ...
    parser.add_argument("--toword_loss", default='text+img', help="which loss to use ['text', 'img', 'text+img']")
    ...
    parser.add_argument("--com_root_dir", default="/data1")
